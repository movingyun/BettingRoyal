        ...
        this.setState(
            ...
            () => {
                ...
                mySession.on('streamCreated', (event) => {
                    ...
                    var subscriber = mySession.subscribe(event.stream, undefined, {insertMode: 'APPEND'});
                    console.log("##########")
                    ...
                    console.log("%%%%%%")
                    console.log(this.state.subscribers)
                    console.log(this.state.subscribers[0])
                    console.log(this.state.subscribers[0].stream.connection.data)
                    var subscribers = this.state.subscribers;
                    subscribers.push(subscriber);
                    // this.state.temp.push(subscriber)
                    // const message = event
