...
class Gameroom extends Component {  
    constructor(props) {
        ...
        this.state = {
            ...
            expressions: [
                [
                {subject: 'angry', value: 0},
                {subject: 'fearful', value: 0},
                {subject: 'happy', value: 0},
                {subject: 'neutral', value: 0},
                {subject: 'sad', value: 0},
                {subject: 'suprised', value: 0},
              ],
              [
                {subject: 'angry', value: 0},
                {subject: 'fearful', value: 0},
                    ...
                    <div className={styles.grid}>
                        {this.state.publisher !== undefined ? (
                            <div onClick={() => this.handleMainVideoStream(this.state.publisher)} className={styles.myCam}>
                                <UserVideoComponent
                                    streamManager={this.state.publisher} updateExpressions={this.updateExpressions()}/>
                            </div>
                        ) : null}
                        {this.state.subscribers.map((sub, i) => (
                            <div key={i} onClick={() => this.handleMainVideoStream(sub)} className={this.test[i]}>
                                <UserVideoComponent streamManager={sub} updateExpressions={this.updateExpressions()}/>
                            </div>
