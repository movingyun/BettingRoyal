...
class Gameroom extends Component {  
        ...
        this.setState(
            ...
            () => {
                ...
                mySession.on("signal:my-chat", (event) => {
                    ...
                    // this.state.setChatArr((chatArr) => chatArr.concat(chatmsg));
    ...
    render() {
        ...
        const setChatArr = this.state.setChatArr;
        return (
            <div>
                    ...
                    <div className={styles.container}>
                        <div className={styles.header}>
                            ...
                            <div className={styles.buttonList}>
                                <button className={styles.button} onClick={this.leaveSession}>관전자모드</button>
                        ...
                        <div className={styles.grid}>
                            ...
                            <div className={styles.playerMe}>
                                <Player handleMainVideoStream={this.handleMainVideoStream()} player={players[0]} state={state} streamManager={this.state.publisher}/>
                            </div>

                            {this.state.subscribers.map((sub, i) => (
                                <div key={i} className="stream-container col-md-6 col-xs-6" onClick={() => this.handleMainVideoStream(sub)}>
                                    <div className={styles.player+{i} }>
                                        <Player handleMainVideoStream={this.handleMainVideoStream()} idx={i} player={players[i]} state={state} streamManager={sub}/>
                                    </div>
                                </div>
                            ))}
